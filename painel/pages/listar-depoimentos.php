<?php
	if(isset($_GET['excluir'])){
		//inval retorna um valor inteiro,ou seja o id do depoimento
...
<div class="box-content">
	...
	<table>
		...
		<tr>
			...
			<td><a actionBtn="delete" class="btn delete" href="<?php echo INCLUDE_PATH_PAINEL ?>
			listar-depoimentos?excluir=<?php echo $value['id']; ?>"><i class="fa fa-times"></i> Excluir</a></td>
	...
	<div class="paginacao">
		<?php
		//pega o numero total de depoumentos, $porPagina é a quantidade de depomentos que mostrara por pagina
		//ceil arredonda a p cima
