<section class="banner-container">
	...
	<div style="background-image: url('<?php echo INCLUDE_PATH; ?>img/img1.jpg');" class="banner-single"></div><!-- banner-single -->
	<div style="background-image: url('<?php echo INCLUDE_PATH; ?>img/img2.jpg');" class="banner-single"></div><!-- banner-single -->
	...
	<section class="descricao-autor">
		<div class="center">
		<div class="w100 left">
			<h2 class="text-center"><img src="<?php echo INCLUDE_PATH ?>img/FotoEder.png" /> <?php echo $infoSite['nome_autor']; ?></h2>
